...
export const metadata: Metadata = {
  title: "梱包動画 導入ガイド2026 - カメラ設置から運用まで完全網羅",
  description:
    "梱包動画を初めて導入するセラーのための2026年最新ステップ別ガイド。カメラの設置位置・角度、梱包台のセッティング、バーコード連携、スタッフ教育、クレーム対応、業種別の導入ポイントまで1ページにまとめました。",
  keywords: [
    "梱包動画 導入",
    "梱包動画 設置",
    "梱包動画 カメラ 位置",
...
const FAQ = [
  ...
  },
  {
    ...
    a: "標準で3か月間クラウドに保管されます。宅配クレームの約90%が出荷後30日以内に発生するため、3か月でほとんどをカバーできます。保管期間の選択基準は梱包動画の保管期間に関する記事を参考にしてください。",
  },
  {
  ...
  },
  {
    ...
    a: "梱包動画は梱包台1台につきカメラ1台+月30,000ウォンの構成です。クレームが集中する梱包台から優先的に導入し、段階的に拡大する方法も可能です。",
  },
  {
    q: "導入コストに見合う効果は本当にありますか?",
    a: "梱包動画の1か月の費用(30,000ウォン)は、不当な返金を1件減らすだけで回収できます。月1,000件出荷を基準とした実際の削減額シミュレーションは、クレームコストのシミュレーション記事で確認できます。",
  },
];

...
const PREP = [
  ...
  { item: "攝影機（USB 網路攝影機或 IP 攝影機）", note: "從 NT$1,200～2,300 等級的 USB 網路攝影機起即相容" },
...
const FAQ = [
  ...
  {
    q: "應該買哪種攝影機？",
    a: "個人・小型賣家用 NT$1,200～2,300 等級的 USB 網路攝影機就足夠。若有 3 個以上的包裝台，建議使用 FHD 工業級攝影機或 PoE IP 攝影機。各規模場所的攝影機選擇基準，已詳細整理在包裝影片攝影機推薦文章中。",
  },
  {
    q: "攝影機要裝在什麼高度・角度？",
  ...
  {
    q: "包裝影片會保存多久？",
    a: "預設在雲端保存 3 個月。多數客訴會在出貨後一個月內提出，但也有不少涉及換貨、重新出貨或延遲提出的爭議。監視器（CCTV）或保存期限僅一個月的服務難以應付這類較晚的客訴，而 Zeropacking 保存 3 個月，連較晚發生的爭議也能安全涵蓋。",
  },
  {
    q: "就算員工換人，運作上也沒問題嗎？",
  ...
  {
    q: "有多個包裝台，全部都要安裝嗎？",
    a: "包裝影片是每個包裝台 1 台攝影機 ＋ 每月 990 元的架構。也可以先從客訴集中的包裝台優先導入，再分階段擴大。",
  },
  {
    q: "導入成本相比成效真的划算嗎？",
    a: "包裝影片一個月的費用（990 元）只要減少 1 筆不當退款就能回本。以每月 1,000 筆出貨為基準的實際節省金額模擬，可在客訴成本模擬文章中查看。",
  },
];

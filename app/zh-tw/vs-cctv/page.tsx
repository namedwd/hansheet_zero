...
const TABLE = [
  ...
  {
    item: "初期成本",
    cctv: "約 5～20 萬元（DVR ＋ 大容量硬碟 ＋ 施工）",
    pv: "0 元（每個包裝台每月 990 元）",
  },
  {
    item: "法律舉證能力",
    cctv: "時間點與關聯性難以證明",
...
const FAQ = [
  ...
  },
  {
    ...
    a: "比較初期成本，包裝影片反而便宜許多。CCTV 光是 DVR・硬碟・施工費就要約 5～20 萬元，而包裝影片以單一包裝台計算為每月 990 元，且沒有額外的初期費用。大多數賣家只要少一件客訴，一個月的費用就能回收。",
  },
];
